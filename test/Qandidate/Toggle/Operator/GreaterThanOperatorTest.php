...
class GreaterThanOperatorTest extends TestCase
{
     ...
     */
    public function it_applies_to_greater_values(int|float $value, int|float $argument): void
    {
     ...
     */
    public function it_does_not_apply_to_equal_values(int|float $value, int|float $argument): void
    {
        $operator = new GreaterThan($value);
     ...
     */
    public function it_does_not_apply_to_smaller_values(int|float $value, int|float $argument): void
    {
        $operator = new GreaterThan($value);
        $this->assertFalse($operator->appliesTo($argument));
    }
