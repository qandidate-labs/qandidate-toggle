...
class ToggleTest extends TestCase
{
    ...
    public function createUser()
    {
        ...
        $user->id = 12;
        $user->isActive = true;
        $user->tags = array('qandidate', 'symfony2');
     ...
     * @test
     */
    public function it_should_evaluate_a_symfony_expression()
    {
        $context = new Context();

        $context->set('product', array('price' => '30'));
        $expression = 'product["price"] > 10';
     ...
     * @test
     */
    public function it_should_evaluate_mixed_conditions()
    {
        $context = new Context();
        ...
        $conditions = array(
            'product["price"] < 10',                            // symfony2 expression
            new OperatorCondition('age', new GreaterThan(42))   // normal operator
        );
     ...
     * @test
     */
    public function it_should_evaluate_symfony_expressions_with_objects()
    {
        $context = new Context();
        ...
        $conditions = array(
            'product["price"] > 10 and user.isActive and "symfony2" in user.tags'
        );
